...
with col2:
    indicator = st.selectbox('Select a Score',
                             ('Enrolment score', 'Gender parity score',
                              'Learning score', 'Retention score', 'School infrastructure score',
                              'Education score'))
...
fig.update_layout(
    title=f"Schools with Percentage of {indicator} in {province} over the selected years",
    xaxis_title="City",
